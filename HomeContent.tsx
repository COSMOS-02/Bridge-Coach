        ...
        <section className="mx-auto max-w-6xl px-4 pb-12 pt-10 sm:px-6 sm:pb-16 sm:pt-16">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
            <div>
              ...
              </div><div className="mt-6 flex flex-wrap gap-3 text-sm text-slate-300">
  <span className="rounded-full border border-cyan-500/20 bg-slate-900/70 px-4 py-2">
    ✨ AI Powered
  </span>
...
function SamplePath({ rank, name, score }: { rank: number; name: string; score: number }) {
  return (
    <div className="rounded-3xl border border-slate-800 bg-slate-950/90 p-4 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:border-cyan-400/50 hover:shadow-cyan-500/20">
